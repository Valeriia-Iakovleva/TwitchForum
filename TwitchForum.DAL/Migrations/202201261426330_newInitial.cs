namespace TwitchForum.DAL.Migrations
{
    ...
    public partial class newInitial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Discussions", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Discussions", "ChannelId", "dbo.Channels");
            DropForeignKey("dbo.Answers", "DiscussionId", "dbo.Discussions");
            ...
            DropIndex("dbo.Discussions", new[] { "ChannelId" });
            DropIndex("dbo.Answers", new[] { "DiscussionId" });
